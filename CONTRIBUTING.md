...
# Contributing to dxatscale-template

First and foremost, **thank you**! We appreciate that you want to contribute to dxatscale-template, your time is valuable, and your contributions mean a lot to us.
...
Please only create issues for bug reports or feature requests at [dxatscale-template repo](https://github.com/dxatscale/dxatscale-template). Issues discussing any other topics may be closed by the project’s maintainers without further explanation.
